...
<div class="imgcontainer">
  ...
  <div class="container">
	...
	<%
		String namesucc=(String)session.getAttribute("name");
  		if(namesucc!=null){	%>
  		
  			<div class="container col-md-6 pt-5 text-danger">
		
					
				 
				 <h2>Congratulation,   Welcome to WIS.</h2>
		  	...
		  	<div class="container col-md-6 pt-5 ">
				 ...
				 <a class="btn btn-primary" href="invalidate.jsp" >Logout</a>
