...
<div class="imgcontainer">
  ...
  <div class="container">
	<div class="row">
		...
		<div class="container col-md-4 pt-4">
				...
				<button class="btn btn-primary">
				  ...
				  Checking your information. Please waiting...
				</button>
		</div>
			...
			String namechk=request.getParameter("UserName");
			String passwordchk=request.getParameter("UserPassword");
			if(namechk==null) response.sendRedirect("login.jsp");
			else {
	...
	try {
		...
		while(rs.next()) {
			if ((rs.getString("UserName").equals(namechk))&&(rs.getString("UserPassword").equals(passwordchk)))
				login=true;	
	...
	if (login==true) {
		session.setAttribute("name",namechk);
